...
```{r p5_sum, echo=FALSE, out.width = '90%', fig.align='center'}
knitr::include_graphics("./p5_sum.jpg")
```
* The effect the previous wind speed has will decrease over years

# Seasonal Difference Exploration and Wind Change against Year - Model 2 & 3
```{r p5_sum_new, echo=FALSE, out.width = '90%', fig.align='center'}
knitr::include_graphics("./p5_sum2.jpg")
...
knitr::include_graphics("./p5_sum_new.jpg")
```
* The impact of the nearst past wind speed has on current wind speed will decrease across years
...
- The $\beta_i$ coefficients estimated from the Bayesian model is powerful when predicting the damage and deaths caused by hurricanes