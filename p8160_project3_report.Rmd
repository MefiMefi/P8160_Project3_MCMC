...
\begin{center}
Figure 7. Trace plots of model parameters, based on 10000 MCMC sample
\end{center}
...
```
\begin{center}
Figure 8. Trace plots of variance parameters, based on 10000 MCMC sample
\end{center}
...
```
\begin{center}
Table 8. Coefficients of Each Hurricane
\end{center}
...
```
\begin{center}
Table 9. Coefficients of Deaths Prediction
\end{center}
...
```
\begin{center}
Table 10. Coefficients of Damage Prediction
\end{center}
